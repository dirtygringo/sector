...
{
    internal class RabbitMqConfiguration : IMessageConfiguration
    {
        #region Fields
        ...
        public IMessageConfiguration SubscribeToEvent<TEvent>() where TEvent : class, IEvent
        {
        ...
        public IMessageConfiguration SubscribeToCommand<TCommand>() where TCommand : class, ICommand
        {
